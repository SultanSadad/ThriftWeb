    ...
    <div class="bg-white rounded p-8 w-full max-w-md shadow-md">
      ...
      <form id="form-login" action="#" class="w-full">
        ...
        <div class="flex justify-center items-center mb-6">
          <button type="submit" class="bg-blue-900 hover:bg-blue-800 text-white font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline">Masuk</button>
        </div>
      </form>
      <p class="text-center">Belum punya akun? <a href="Login" class="font-bold">Daftar</a></p>
    </div>
  </div>
</div>
